...
public class AppData extends Application {
    ...
    public List<Items> getClothingData(){
        String[]data={"Stockings","Underwear","Pajamas","T-Shirts","Causal Dress","Evening Dress","Shirt","Cardigan","Vest","Jacket","Skirt","Trousers","Jeans","Shorts","Suit","Coat","Rain coat","Glove","Hat","Scarf","Bikini","Belt","Slipper","Sneakers","Causal Shoes","Heeled Shoes","Sports Wear"};
    ...
    public List<Items> getBabyNeedsData(){
        String[]data={"Snapsuit","Outfit","Jumpsuit","Baby Socks","Baby Hat","Baby Pyjamas","Baby Bath Towel","Muslin","Blanket","Dribble Bibs","Baby Laundry Detergent","Baby Bottles","Baby Food Thermos","Baby Bottle Brushes","Brest-feeding Cover","Breast Pump",
        "Water Bottle","Storage Container","Baby Food Spoon","Highchairs","Diaper","Wet Wipes","Baby Cotton","Baby Care Cover","Baby Shampoo","Baby sopa","Baby Nail Scissors","Body Moisturizer","Potty","diaper Rash Cream","Serum Physiological","Nasal Aspirator","Fly Repellent Lotion","Pyrometer","Antipyretic Syrup","Probiotic Power","Baby Backpack","Stroller","Baby Carrier","Toys","Teether","Playpen","Baby radio","Non-slip Sea Shoes","Baby Sunglasses"};
        return prepareItemsList(MyConstants.BABY_NEEDS_CAMEL_CASE,data);
    }

    public List<Items> getHealthData(){
        String[]data={"Aspirin","Drugs Used","Vitamins Used","Lens Solutions","Condom","Hot Water Bag","Tincture of Lodine","Adhesive Plaster","First Aid Kit","Replacement Lens","Pain Reliever","Fever Reducer","Pain Relieve Spray"};
    ...
    public List<Items> getTechnologyData(){
        String[]data={"Mobile Phone","Phone Cover","E-Book Reader","Camera","Portable Speaker","IPad","Headphone","Laptop","Mouse","Extension Cable","Battery","Power bank","DVD Player","Flash-Light","Voltage Adapter","SD Card"};
        return prepareItemsList(MyConstants.TECHNOLOGY_CAMEL_CASE,data);
    }

    public List<Items> getBeachSuppliesData(){
        String[]data={"Sea Glasses","Sea Bed","Suntan Cream","Beach Umbrella","Swim Fins","Beach Bag","Beach Towel","Sunbed","Snorkel"};
    ...
    public List<Items> getNeedsData(){
        String[]data={"Backpack","Daily Bag","Laundry Bags","Seeing Kit","Travel Lock","Sports Equipment","Important Numbers"};
    ...
    private List<Items> deleteAndGetListByCategory(String category,Boolean onlyDelete){
        if (onlyDelete){
            database.mainDao().deleteAllByCategoryAndAddBy(category,MyConstants.SHOW_SMALL);
        }else {
